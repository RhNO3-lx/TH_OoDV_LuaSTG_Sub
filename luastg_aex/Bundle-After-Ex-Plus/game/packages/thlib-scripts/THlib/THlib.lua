...
Include("THlib/customized-extension/additional_resources.lua")
Include("THlib/customized-extension/dialog_ext.lua")
Include("THlib/customized-extension/player_death_effect.lua")
--Include("THlib/customized-extension/dialog-ext/Muki_custom_dialog.lua")